        ...
        {items.map((item) => (
          ...
          >
            <section className="w-full flex flex-col justify-between">
              ...
              ></div>
              <div className="relative z-20 text-xs lg:text-sm leading-[1.6] text-gray-900 font-bold">
                {item.quote}
              </div>

              <div className="flex flex-col gap-1 mt-5">
                <span className="text-xs lg:text-sm lg:leading-[1.6] text-gray-900 font-bold">
                  {item.name}
                </span>
                <span className="text-xs lg:text-sm lg:leading-[1.6] text-gray-900 font-bold">
                  {item.title}
